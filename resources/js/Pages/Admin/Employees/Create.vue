...
const form = useForm({
  ...
  annual_leave_quota: props.defaultAnnualLeaveQuota || 12,
  bank_name: 'Bank DKI',
  account_number: '',
...
const submit = () => {
  ...
  if (!form.password) {
    form.setError('password', 'Kata sandi awal wajib diisi');
    hasError = true;
  ...
  if (!form.position || !form.position.trim()) {
    form.setError('position', 'Jabatan / profesi pegawai wajib diisi');
    hasError = true;
  }
...
<template>
  <AdminLayout>
    <Head title="Tambah Pegawai Baru Transjakarta" />
          ...
          <div class="flex items-center gap-2.5">
            ...
            <div>
              <div class="flex items-center gap-2">
                <h1 class="text-base font-bold text-slate-900 leading-tight">Formulir Tambah Pegawai</h1>
                <span class="px-2 py-0.5 text-[10px] font-extrabold rounded-md bg-blue-100 text-blue-700 uppercase">
                  Transjakarta
                </span>
              </div>
              <p class="text-xs text-slate-400">Daftarkan staf baru ke dalam sistem penempatan wilayah operasional Transjakarta</p>
            </div>
          </div>
          <Link 
        ...
        <form novalidate @submit.prevent="submit" class="space-y-6">
          ...
          <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label class="block text-xs font-bold uppercase tracking-wider text-slate-600 mb-1.5">Kata Sandi Awal *</label>
                <input 
                  ...
                  class="w-full px-3.5 py-2.5 text-xs rounded-xl border border-slate-200 bg-slate-50 text-slate-900 focus:bg-white focus:border-blue-600 focus:ring-2 focus:ring-blue-500/20 outline-none transition-all" 
                />
                <span class="text-[11px] text-slate-400 block mt-1">Default: password123</span>
              ...
              <div>
                <label class="block text-xs font-bold uppercase tracking-wider text-slate-600 mb-1.5">Nomor Telepon / WhatsApp</label>
                <input 
                  v-model="form.phone" 
              ...
              <div>
                ...
                <input 
                  ...
                  placeholder="Otomatis (TJT / TJV / TJB)" 
                />
                <span class="text-[11px] text-slate-400 block mt-1">Kosongkan untuk auto-generate: <strong>TJT</strong> (Tetap), <strong>TJV</strong> (Vendor), <strong>TJB</strong> (Magang)</span>
          ...
          <!-- Section 3: Posisi, Departemen & Jadwal -->
          <div class="pt-4 border-t border-slate-100">
            <h6 class="text-xs font-bold text-blue-600 uppercase tracking-wider mb-3">
          ...
          <div class="pt-6 border-t border-slate-100 flex items-center justify-end gap-3">
            ...
            >
              ...
              <span>Simpan Pegawai Transjakarta</span>
            </button>
          </div>
        </form>
      </div>
