        ...
        <div class="flex items-center justify-between pb-4 mb-5 border-b border-slate-100">
          <div class="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p class="text-xs text-slate-400">Daftarkan akun dan penugasan shift staf baru</p>
            </div>
          </div>
          <Link 
        ...
        <form novalidate @submit.prevent="submit" class="space-y-6">
          ...
          <div class="pt-4 border-t border-slate-100">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <span class="text-[11px] text-slate-400 block mt-1">Default sistem: {{ defaultAnnualLeaveQuota }} hari/tahun</span>
              </div>
            </div>
          </div>
          ...
          <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
            ...
            >
              ...
              <span v-else>Simpan Data Pegawai</span>
            </button>
          </div>
        </form>
      </div>
